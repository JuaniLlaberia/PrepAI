...
import DifficultyBadge from '@/app/dashboard/exams/(components)/DifficultyBadge';
...
const QuestionPage = async ({
  ...
  return (
    <>
      ...
      <section className='tracking-tight bg-background-2 mb-3 p-4 rounded-xl border-[1px] border-b-[2.5px] border-border'>
      ...
      <section className='tracking-tight bg-background-2 p-4 rounded-xl border-[1px] border-b-[2.5px] border-border'>
        <h2 className='mb-2 text-sm lg:text-base xl:text-lg font-semibold'>
          Answer
        </h2>
